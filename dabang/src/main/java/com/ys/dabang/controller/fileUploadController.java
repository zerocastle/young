...
import com.ys.dabang.vo.FileUploadVo;
...
public class fileUploadController {
	...
	@ResponseBody
	public ResponseEntity<List<FileUploadVo>> uploadAjaxAction(@RequestParam("article_file") MultipartFile[] uploadFile,
		...
		for (MultipartFile multipartFile : uploadFile) {
			...
			FileUploadVo production_uploadVO = new FileUploadVo();
